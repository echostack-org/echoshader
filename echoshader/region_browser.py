...
def region_browser(ds, regions_df, cache_backgrounds=True):
    ...
    def save_changes(event):
        ...
        nonlocal poly_draw_stream, sample_df, status
    ...
    def reset_edits(event):
        ...
        nonlocal sample_df, original_df, status
    ...
    def load_csv_file(event):
        ...
        nonlocal sample_df, region_dropdown, status
